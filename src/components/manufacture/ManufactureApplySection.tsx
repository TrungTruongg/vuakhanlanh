    ...
    <section className="py-24 bg-surface-mint">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          ...
          <p className="text-black text-center mt-3 max-w-3xl mx-auto reveal reveal-in">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 reveal-stagger">
          {applications.map((app) => (
            <div key={app.id} className="bg-white rounded-4xl p-7 shadow-sm hover:shadow-md hover:scale-105 transition border border-outline-variant">
